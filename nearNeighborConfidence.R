...
for (expnum in 1:9){
  ...
  confidenceData <- read_csv(paste("~/MATLAB/nearNeighborExp", toString(expnum), "forConfidence.csv", sep = ""))
...
write.table(confidence.data,  file = paste("~/MATLAB/nearNeighborMeansRadii.csv", sep = ""))
